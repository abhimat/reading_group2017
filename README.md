...
|2017-05-19| TBD | Python Data Science Handbook, In-Depth: [Support Vector Machines](http://nbviewer.jupyter.org/github/jakevdp/PythonDataScienceHandbook/blob/master/notebooks/05.07-Support-Vector-Machines.ipynb), Supplementary: [Hands-On Machine Learning](http://proquest.safaribooksonline.com/book/programming/9781491962282), Chapter 5 | A. Gautam, D Cohen, K. Kosmo |
